...
## [v2.2.2] - 2026-02-17
### Security
- [#128] Fix Go stdlib CVE-2025-68121

## [v2.2.1] - 2026-02-03
### Fixed
- [#126] Upgrade dogu-lib to retrieve the dogu definition with the immutable sotrageclass to fix update errors when restarting the dogus.
...
- [#124] exclude configuration values from import
  ...
  - new option `config.job.excludedGlobalConfigurationKeys` for excluding global configuration keys from being imported
