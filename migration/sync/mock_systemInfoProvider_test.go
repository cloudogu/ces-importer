...
func (_m *mockSystemInfoProvider) GetSystemInfo(ctx context.Context) (*exporter.SystemInfo, error) {
	ret := _m.Called(ctx)
...
func (_c *mockSystemInfoProvider_GetSystemInfo_Call) Return(systemInfo *exporter.SystemInfo, err error) *mockSystemInfoProvider_GetSystemInfo_Call {
	_c.Call.Return(systemInfo, err)
	return _c
}

func (_c *mockSystemInfoProvider_GetSystemInfo_Call) RunAndReturn(run func(context.Context) (*exporter.SystemInfo, error)) *mockSystemInfoProvider_GetSystemInfo_Call {
	_c.Call.Return(run)
	return _c
}
