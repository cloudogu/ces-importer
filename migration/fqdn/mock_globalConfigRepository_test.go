...
func (_m *mockGlobalConfigRepository) SaveOrMerge(ctx context.Context, globalConfig config.GlobalConfig) (config.GlobalConfig, error) {
...
// mockGlobalConfigRepository_SaveOrMerge_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SaveOrMerge'
type mockGlobalConfigRepository_SaveOrMerge_Call struct {
	*mock.Call
}
...
func (_e *mockGlobalConfigRepository_Expecter) SaveOrMerge(ctx interface{}, globalConfig interface{}) *mockGlobalConfigRepository_SaveOrMerge_Call {
	return &mockGlobalConfigRepository_SaveOrMerge_Call{Call: _e.mock.On("SaveOrMerge", ctx, globalConfig)}
}

func (_c *mockGlobalConfigRepository_SaveOrMerge_Call) Run(run func(ctx context.Context, globalConfig config.GlobalConfig)) *mockGlobalConfigRepository_SaveOrMerge_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockGlobalConfigRepository_SaveOrMerge_Call) Return(_a0 config.GlobalConfig, _a1 error) *mockGlobalConfigRepository_SaveOrMerge_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockGlobalConfigRepository_SaveOrMerge_Call) RunAndReturn(run func(context.Context, config.GlobalConfig) (config.GlobalConfig, error)) *mockGlobalConfigRepository_SaveOrMerge_Call {
	_c.Call.Return(run)
	return _c
}
