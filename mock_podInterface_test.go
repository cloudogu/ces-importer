...
func (_m *mockPodInterface) GetLogs(name string, opts *v1.PodLogOptions) *rest.Request {
...
func (_c *mockPodInterface_GetLogs_Call) Run(run func(name string, opts *v1.PodLogOptions)) *mockPodInterface_GetLogs_Call {
...
func (_c *mockPodInterface_GetLogs_Call) RunAndReturn(run func(string, *v1.PodLogOptions) *rest.Request) *mockPodInterface_GetLogs_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function with given fields: ctx, opts
func (_m *mockPodInterface) List(ctx context.Context, opts metav1.ListOptions) (*v1.PodList, error) {
...
func (_c *mockPodInterface_List_Call) Return(_a0 *v1.PodList, _a1 error) *mockPodInterface_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockPodInterface_List_Call) RunAndReturn(run func(context.Context, metav1.ListOptions) (*v1.PodList, error)) *mockPodInterface_List_Call {
	_c.Call.Return(run)
	return _c
}
